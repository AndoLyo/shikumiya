...
const stats = [
  { icon: Clock, value: "月40時間", desc: "の作業を自動化", color: "text-cyan-400" },
  { icon: BookOpen, value: "開発日記", desc: "をnoteで連載中", color: "text-amber-400" },
  { icon: Eye, value: "すべて公開", desc: "失敗も含めて共有", color: "text-emerald-400" },
];
