          ...
          {solutions.map((s, i) => {
            ...
            return (
              ...
              >
                ...
                <div className={`relative z-10 p-7 sm:p-8 h-full ${hasImage ? "bg-[#0d0d15]/60 backdrop-blur-sm" : "bg-[#0d0d15]/40"}`}>
                  {/* Icon */}
                  <div className={`w-12 h-12 rounded-xl ${s.iconBg} border border-white/[0.08] flex items-center justify-center mb-5 transition-all duration-300 group-hover:scale-110`}>
